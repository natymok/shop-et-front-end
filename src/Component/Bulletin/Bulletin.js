...
function Bulletin({img1,img2}) {
  ...
  return (
    <div ref={Bulletienref} className=' w-[100%] h-[250px] gap-[150px] hidden md:flex md:flex-nowrap md:overflow-x-scroll md:scrollbar-none scroll-smooth   object-cover py-5 px-[150px] rounded-lg'>
